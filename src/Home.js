  ...
  const allTxnsColumns = [
    {
      ...
      render: (transaction_id) => {
        return (
          <a target="_blank" href={`/trxnGraph/${transaction_id}`}>
            {transaction_id}
          </a>
        );
      },
    ...
    <div className="tw-bg-gray-200">
      ...
      {loading ? (
        ...
        <div className="tw-p-4">
          <div
            className="tw-font-light tw-text-sm tw-absolute"
            style={{ right: "10px" }}
          >
            HIGHLY CONFIDENTIAL INFORMATION
          </div>

          <div className="tw-font-bold tw-mb-4 tw-text-2xl">
            Transaction Metrics
          </div>
          ...
          <div className="tw-font-light tw-mb-4 tw-text-sm">
            "CONFIDENTIAL: The contents of this page are highly classified and
            strictly confidential. Unauthorized access, disclosure, or
            dissemination of the information contained herein is strictly
            prohibited and may result in severe legal consequences. This page
            contains sensitive and privileged information that is intended
            solely for authorized individuals or entities.
          </div>
        </div>
      )}
    </div>
